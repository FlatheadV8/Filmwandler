...
while [ "${#}" -ne "0" ]; do
        ...
        -soll_xmaly 720x576
        -out_xmaly 1920x1080
        -soll_xmaly 128x96	# ein 3GPP-Format
        -soll_xmaly 176x144	# ein 3GPP-Format
        -soll_xmaly 352x288	# ein 3GPP-Format
        -soll_xmaly 704x576	# ein 3GPP-Format
        -soll_xmaly 1408x1152	# ein 3GPP-Format
