...
while [ "${#}" -ne "0" ]; do
        ...
        -soll_xmaly 1920x1080		# englischer Parametername
	-soll_xmaly SQCIF		# 128x96
	-soll_xmaly QQVGA		# 160x120
	-soll_xmaly GB			# 160x144
	-soll_xmaly QCIF		# 176x144
